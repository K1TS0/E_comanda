     ...
     if(empty($requestData['NOME'])){
          ...
          if($operacao == 'insert'){
               try{
                    ...
                    INSERT INTO CLIENTE > Pegar os dados da tabela CLIENTE, especificados dentro dos parênteses
                    ...
                    */
                    ...
                    $stmt -> execute(array(
                         ...
                         $_SESSION['ID'] > Como só são mostrados os clientes da empresa logada, é só pegar o ID dessa sessão
                         */
