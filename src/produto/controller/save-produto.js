     ...
     $('.btn-save').click(function(e) {
          ...
          */
          ...
          $.ajax({
               ...
               url: 'src/produto/model/save-produto.php',//Para onde as informações serão enviadas

               //Se tudo isso der certo, essa manipulação vai acontecer, qual recebe os dados do save-produto.php
               success: function(dados){
                    ...
                    $('#table-produto').DataTable().ajax.reload() //Atualiza a tabela com as informações salvas
               }
          })
     })
})