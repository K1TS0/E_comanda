               ...
               success: function(dado) {
                    ...
                    if(dado.tipo == 'success'){
                         ...
                         $('.modal-body').load('src/produto/view/form-produto.html', function(){
                              /*#NOME > vem do ID da list-produto
                              val(dado.dados.NOME) > Esse campo vai receber um valor, onde a variável 'dado' (criada nesse arquivo) vai receber o valor localizado no PHP (view-produto.php) na variável 'dados', pegando o valor 'NOME'
                              */
                         ...
                         $('#modal-produto').modal('show') //Para aparecer o modal
                    }else{
                    //SweetAlert
                         Swal.fire({
