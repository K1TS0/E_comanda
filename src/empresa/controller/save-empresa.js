     ...
     $('.btn-save').click(function(e) {
          ...
          */
          ...
          $.ajax({
               ...
               url: 'src/empresa/model/save-empresa.php',//Para onde as informações serão enviadas

               //Se tudo isso der certo, essa manipulação vai acontecer, qual recebe os dados do save-empresa.php
               success: function(dados){
                    ...
                    $('#table-empresa').DataTable().ajax.reload() //Atualiza a tabela com as informações salvas
               }
          })
     })
})